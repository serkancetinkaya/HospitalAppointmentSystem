...
{
    public partial class DiseasedEkle : Form
    {
        public DiseasedEkle()
        {
            InitializeComponent();
        ...
        private void buttonEkle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                LogicDiseased.LLDiseasedEkle(ent);
                MessageBox.Show("Yeni hasta başarılı şekilde kayıt edilmiştir");
        ...
        private void DiseasedEkle_Load(object sender, EventArgs e)
        {
